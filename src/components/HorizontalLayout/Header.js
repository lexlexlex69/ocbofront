          ...
          <div className="d-flex">
            ...
            >
              <DropdownToggle className="btn header-item " caret tag="button">
                {props.t("Services")} <i className="mdi mdi-chevron-down" />
              </DropdownToggle>
              <DropdownMenu
                    ...
                    <Row>
                      <Col sm={6}>
                        <h5 className="font-size-14 mt-0">
                          {props.t("Available Services")}
                        </h5>
                        <ul className="list-unstyled megamenu-list">
                          <li>
                            <Link to="#">{props.t("Permit Application")}</Link>
                          </li>
                          <li>
                            <Link to="#">{props.t("Checklist Generator")}</Link>
                          </li>
                        </ul>
                      </Col>
                    </Row>

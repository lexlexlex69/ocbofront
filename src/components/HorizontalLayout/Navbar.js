...
const Navbar = (props) => {
  ...
  return (
    <React.Fragment>
      <div
        className="topnav"
        style={{ fontWeight: "500", backgroundColor: "#717171" }}
      >
        <div
              ...
              <ul className="navbar-nav">
                ...
                <li className="nav-item dropdown">
                  ...
                  >
                    ...
                    {props.t("Request Status")} {props.menuOpen}
                  ...
                  >
                    <Link to="/dashboard" className="dropdown-item">
                      {props.t("Application Permit")}
                    </Link>
                    <Link to="/dashboard-saas" className="dropdown-item">
                      {props.t("Building Permit Checklist")}
                    </Link>
                  </div>
                </li>
                    ...
                    <div className="dropdown">
                      ...
                      >
                        <Link to="/email-inbox" className="dropdown-item">
                          {props.t("Building Permit")}
                        </Link>
                        <Link to="/email-read" className="dropdown-item">
                          {props.t("Occupancy Permit")}
                        </Link>
                      </div>
                    </div>
                  </div>

      ...
      <>
        <Row>
          <Col lg={12} style={{ padding: "0px" }}>
            <CustomCard title="Land Ownership">
              <Row className="mb-3">
                <Col md="12">
                  <CustomSelect
            ...
            <CustomCard title="project location">
              <Row className="mb-3">
                <Col md="6">
                  <CustomInput
                    label="Project Title"
                ...
                <Col md="3">
                  <CustomInput label="Lot No" name="projLocLotNo" type="text" />
                </Col>
                <Col md="3">
                  <CustomInput label="Blk No" name="projLocBlkNo" type="text" />
                </Col>
              </Row>
              <Row className="mb-3">
                <Col md="6">
                  <CustomInput label="Tct No" name="projLocTctNo" type="text" />
                </Col>
                <Col md="3">
                  <CustomInput
                    label="Street"
              ...
              <Row className="mb-3">
                ...
                <Col md="3">
                  <CustomInput label="City" name="projLocCity" type="text" />
                </Col>
              </Row>
            </CustomCard>
            <CustomCard title="applicant">
              <Row className="mb-3">
                <Col md="5">
                  <CustomInput
                    label="Surname"
              ...
              <Row className="mb-3">
                <Col md="5">
                  <CustomInput label="Tel No" name="applicantTel" type="text" />
                </Col>
              </Row>
            </CustomCard>
            <CustomCard title="AUTHORIZED REPRESENTATIVE'S DETAILS (OPTIONAL)">
              <CustomSwitch
              ...
              {values.authorizedSwitch && (
                <>
                  <Row className="mb-3">
                    ...
                    <Col md="1">
                      <CustomInput label="M.I" name="authorizeMI" type="text" />
                    </Col>
                    <Col md="1">
                      <CustomInput
                        label="Suffix"
            ...
            <CustomCard title="Additional Information">
              <Row className="mb-3">
                <Col md="12">
                  <CustomSelect

  ...
  return (
    <>
      <tr>
        ...
        <td>{selectValuesDisplay(ownershipFD, values.landOwnershipStatus)}</td>
      </tr>
      ...
      <tr>
        ...
        <td>
          {selectValuesDisplay(workScopeCheckistFD, values.AddInfoTypeActivity)}
        </td>
      </tr>
      <tr>
        <td>{"Scope of Work"}.</td>
        <td>
          {
            <span style={{ display: "flex" }}>
              {values.addInfoworkScopeChecklist.map((val) => `${val.label}, `)}
            </span>
          }
        </td>
      </tr>
